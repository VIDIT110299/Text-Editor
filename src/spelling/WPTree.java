...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		Iterator<WPTreeNode> iterator = queue.iterator();
		while(iterator.hasNext() && !visited.contains(word2))
		{
			...
			for(String n: nw.distanceOne(curr.getWord(), true))
			{
				if(visited.contains(n) == false)
				{
					...
					if(n.equals(word2))
					{
						List<WPTreeNode> res = curr.getChildren();
						return res.get(0).buildPathToRoot();
					}
				}
			}
		}

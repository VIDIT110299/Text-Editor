...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		double score, numberOfWords, numberOfSentences, numberOfSyllables;
		
		numberOfWords = getNumWords();
		numberOfSentences = getNumSentences();
		numberOfSyllables = getNumSyllables();
